<template>
    <el-main>
        <el-card>
            ...
            font-weight: 400;
          ">筛选条件</el-tag>
            <el-input placeholder="请输入内容" v-model="contentInput" class="input-with-select"
        ...
        <el-card>
            ...
            " border style="width: 100%">
                ...
                <el-table-column label="志愿地点" prop="volunteerLocation"> </el-table-column>
                <el-table-column prop="date1" label="服务日期"> </el-table-column>
                <el-table-column prop="volunteerType" label="服务类型"> </el-table-column>
        ...
        <div class="block">
            ...
            <el-dialog title="修改志愿申请信息" :visible.sync="dialogFormVisible" slot>
            ...
            <el-form-item label="性别" :label-width="formLabelWidth" prop="sex">
              ...
              <el-radio v-model="Emp.gender" label="女">女</el-radio>
                    ...
                    <el-form-item label="志愿地点" :label-width="formLabelWidth">
                        <el-input v-model="Emp.volunteerLocation" autocomplete="off"></el-input>
                    </el-form-item>
                    <!-- <el-form-item label="身份证号码" :label-width="formLabelWidth">
              <el-input v-model="Emp.IDcard" autocomplete="off"></el-input>
            </el-form-item> -->
                    <el-form-item label="志愿服务类型" :label-width="formLabelWidth">
                        <el-select v-model="Emp.volunteerType" clearable placeholder="请选择">
  ...
  <script>
import {getVolunteerRecord,deleteVolunteerRecord,modifyVolunteerRecord,getOriginRecord
} from "@/api/volunteer";
export default {
    methods: {
        deleteRecord(row) {
            this.$confirm("是否确定要删除" + row.name + "的志愿申请记录?", "删除数据", {
    ...
    computed: {
        searchData: function () {
            if (this.cname == "personName") {
                ...
                let SearchResult = this.volunteerRecord.filter(
                    (item) => String(item.district).indexOf(String(this.contentInput)) > -1
                );
                return SearchResult;
            } else {
