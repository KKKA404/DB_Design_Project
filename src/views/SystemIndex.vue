        ...
        <el-drawer title="修改用户信息" :visible.sync="editUserInfoFormVisible" direction="ltr"
          ...
          <div class="editUserInfoDrawer__content">
            <el-form :model="userInfoForm" style="padding-right: 40px">
              <el-form-item label="用户名" :label-width="formLabelWidth" style="padding-top: 20px; padding-bottom: 10px">
              ...
              <el-form-item label="联系方式" :label-width="formLabelWidth" style="padding-top: 10px; padding-bottom: 10px">
                <el-input v-model="userInfoForm.phoneNumber"></el-input>
              </el-form-item>
              <el-form-item label="年龄" :label-width="formLabelWidth" style="padding-bottom: 10px; margin-bottom: 50px">
            ...
            <div slot="footer" class="editUserInfoDrawer__footer">
              ...
              <el-button type="primary" @click.native.prevent="editUserInfo"
        ...
        <el-drawer title="修改密码" :visible.sync="resetPassWordFormVisible" direction="ltr"
          ...
          <div class="changePasswordDrawer__content">
            <el-form :model="newPassWordForm" style="padding-right: 40px">
              <el-form-item label="旧密码" :label-width="formLabelWidth" style="padding-top: 20px; padding-bottom: 20px">
                <el-input show-password v-model="newPassWordForm.oldPassWord"></el-input>
              </el-form-item>
              <el-form-item label="设置新密码" :label-width="formLabelWidth" style="padding-top: 10px; padding-bottom: 10px">
                <el-input show-password v-model="newPassWordForm.newPassWord"></el-input>
              </el-form-item>
              <el-form-item label="确认新密码" :label-width="formLabelWidth" style="
                  padding-top: 10px;
                  padding-bottom: 10px;
                  margin-bottom: 50px;
                ">
