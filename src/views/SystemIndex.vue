    ...
    <el-header style="margin-top: 5px;">
      ...
      <div align="right">
        ...
        <el-drawer
          ...
          direction="rtl"
          custom-class="showUserInfoDrawer"
          ref="drawer"
          size="36%"
        >
        ...
        <el-drawer
          ...
          direction="ltr"
          custom-class="editUserInfoDrawer"
          ref="drawer"
          size="36%"
        >
          <div class="editUserInfoDrawer__content">
            <el-form :model="userInfoForm" style="padding-right: 40px">
              ...
              <el-form-item
                label="年龄"
                :label-width="formLabelWidth"
                style="padding-bottom: 10px; margin-bottom: 50px"
              >
            ...
            <div slot="footer" class="editUserInfoDrawer__footer">
              <el-button
                @click.native.prevent="changeEditUserInfoFormVisible"
        ...
        <el-drawer
          ...
          direction="ltr"
          custom-class="changePasswordDrawer"
          ref="drawer"
          size="36%"
        >
          <div class="changePasswordDrawer__content">
            ...
            <div slot="footer" class="changePasswordDrawer__footer">
              <el-button
                @click.native.prevent="changeResetPassWordFormVisible"
                style="margin-left: 20px; margin-right: 10px"
              >
                取消
              </el-button>
